...
public class GiftCertificateByHand 
{
		...
		@Test
		public void testGiftCertificateByHand() throws Exception 
		{
			...
			{	
				...
				operation.execute(allObjects, "CLICK", "SavePaymentInfo", "css", "");
				...
				operation.execute(allObjects, "CLICK", "GCpurchaseconf", "css", "");
					...
					String filePath = System.getProperty("user.dir")+"\\TestData\\AutogeneratedTestData\\GiftCertificateByHand.txt";
